...
<link href="/forum/config/custom.css" rel="stylesheet">
<link rel="stylesheet" media="(max-width: 640px)" href="cache/css/custom,base,font-awesome,styles,mobile,colors.css">
<?php echo $data["head"]; ?>
</head>

<body style="background-color: whitesmoke;" class='<?php echo $data["bodyClass"]; ?>'>
